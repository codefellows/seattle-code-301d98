...
1. Deploy your server to a cloud service provider.
1. Configure your deployed front end to connect to your deployed back end.
1. Associate your cloud application instance with server's GitHub repository.
...
- Generally useful and functional
  ...
  - [Deployed](#deployment) live on the Internet.
