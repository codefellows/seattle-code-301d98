...
class App extends React.Component {
  ...
  updateCat = async (catObjToUpdate) => {
    try {
      // TODO: create the url for axios -> id of the cat to be updated in the path parameter
      ...
      // ** Return from Axios -> updatedCat.data
      // TODO: update state with the updated cat returned from axios
